...
function(llvm_update_compile_flags name)
  ...
  if(LLVM_REQUIRES_EH OR LLVM_ENABLE_EH)
    ...
    if(MSVC)
      list(APPEND LLVM_EXTRA_CXXFLAGS "/EHsc")
    endif()
  else()
    if(LLVM_COMPILER_IS_GCC_COMPATIBLE)
      list(APPEND LLVM_EXTRA_CXXFLAGS "-fno-exceptions")
      if(NOT LLVM_ENABLE_UNWIND_TABLES)
        list(APPEND LLVM_EXTRA_CXXFLAGS "-fno-unwind-tables")
        list(APPEND LLVM_EXTRA_CXXFLAGS "-fno-asynchronous-unwind-tables")
      endif()
    elseif(MSVC)
      list(APPEND LLVM_COMPILE_DEFINITIONS _HAS_EXCEPTIONS=0)
      list(APPEND LLVM_EXTRA_CXXFLAGS "/EHs-c-")
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "XL")
      list(APPEND LLVM_EXTRA_CXXFLAGS "-qnoeh")
    endif()
  endif()
  ...
  if(NOT (LLVM_REQUIRES_RTTI OR LLVM_ENABLE_RTTI))
    ...
    if (LLVM_COMPILER_IS_GCC_COMPATIBLE)
      list(APPEND LLVM_EXTRA_CXXFLAGS "-fno-rtti")
    elseif (MSVC)
      list(APPEND LLVM_EXTRA_CXXFLAGS "/GR-")
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "XL")
      list(APPEND LLVM_EXTRA_CXXFLAGS "-qnortti")
    endif ()
  elseif(MSVC)
      list(APPEND LLVM_EXTRA_CXXFLAGS "/GR")
    endif()

  target_compile_options(${name} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${LLVM_EXTRA_CXXFLAGS}>)
...
function(llvm_add_library name)
  ...
  if((ARG_SHARED AND ARG_STATIC) OR ARG_OBJECT)
    ...
    message(STATUS "Reusing PCH for ${obj_name}")
  ...
  if(NOT ${name} STREQUAL "LLVMDemangle" AND NOT ${name} STREQUAL "LLVMSupport" AND NOT LLVM_REQUIRES_RTTI AND NOT LLVM_REQUIRES_EH)
    message(STATUS "Reusing PCH for ${name}")
...
macro(add_llvm_executable name)
  ...
  if(NOT "${sources}" MATCHES "\\.c(;|$)" AND NOT LLVM_REQUIRES_RTTI AND NOT LLVM_REQUIRES_EH)
    message(STATUS "Adding executable ${name} PCH")
    target_precompile_headers(${name} REUSE_FROM LLVMDemangle)
  endif()
